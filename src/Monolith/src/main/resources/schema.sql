...
(
    ...
    constraint un_product_category_name unique (category_name),
    primary key (id)
);
...
(
    id               bigint generated by default as identity (start with 3000) not null,
...
(
    ...
    date_created timestamp with time zone                                  null,
    primary key (id),
    constraint review_check_status check (approved and not banned),
